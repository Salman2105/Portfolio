...
export default function Services() {
  return (
    <section id="services" className="relative py-20 bg-white dark:bg-slate-900 text-center">
      <motion.div
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600 dark:text-sky-400 mb-12 flex items-center justify-center gap-3">
        ...
        <div className="grid md:grid-cols-2 gap-8 text-left">
          {services.map(({ category, icon, roles }) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-slate-50 dark:bg-slate-800 p-6 rounded-xl shadow-md border dark:border-slate-700"
            >
              ...
              <div className="space-y-6">
                {roles.map(({ title, description, tools }) => (
                  ...
                  >
                    <h4 className="text-lg font-semibold text-sky-500 dark:text-sky-400">
                      {title}
                    </h4>
