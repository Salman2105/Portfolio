...
export default function Hero() {
  ...
  const handleDownload = async () => {
    try {
      ...
      const response = await fetch('/Portfolio/Salman_Ahmed_CV.pdf');
      if (!response.ok) {
    ...
    >
      ...
      >
        ...
        <img
          src={meImg}
          alt="Salman Ahmed"
          className="w-36 h-36 md:w-44 md:h-44 rounded-full object-cover border-4 border-sky-400 shadow-lg mb-6"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          {/* Download CV button */}
          <a
            href="/Portfolio/Salman_Ahmed_CV.pdf"
